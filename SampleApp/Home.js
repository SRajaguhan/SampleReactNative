...
class Home extends React.Component {
  ...
  constructor(props){
       ...
       access_token: "",
       expires_in: "", isVisible: false, isLogin: false };
...
const response = await fetch('https://api.linkedin.com/v2/me', {
 ...
 instagramPressed = () => {
  this.props.navigation.navigate('Instapage')
}
...
<View style={styles.container}>
    ...
    />
      ...
      />
      { this.state.isLogin && <Button title="Log Out" onPress={() => this.logOutPressed()} /> }
    </View>
    }
               </View>
             </ScrollView>
